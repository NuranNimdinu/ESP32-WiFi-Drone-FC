...
public:
    ...
    bool init(){
        ...
        // this->init_wifi_sta();
        this->init_wifi_ap("Drone", "1234567890");
    ...
    static void send_init_dt_ws(){
        ...
        const char* DatakeysForWSInit[] = {"motm", "motc", "Rpid", "Ppid", "Ypid", "ARid", "VerR", "VerV"};
...
private:
    ...
    static void wifi_event_handler(void* arg, esp_event_base_t event_base, int32_t event_id, void* event_data){
        ...
        else if(event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) esp_wifi_connect();
    ...
    void init_wifi_ap(const char* ssid, const char* pass){
        ...
        ESP_ERROR_CHECK(esp_event_handler_instance_register(WIFI_EVENT, ESP_EVENT_ANY_ID, &ESP_WIFI_DEV::wifi_event_handler, NULL, NULL));
